...
use super::format_pc;
use emugator_core::emulator::{AnyEmulatorState, cve2::CVE2Pipeline};
...
pub fn CVE2Visualization(
    ...
    let hover_stroke = "#4285F4";
    let hover_fill = "rgba(66, 133, 244, 0.1)";
    ...
    rsx! {
        g {
            ...
            rect {
                ...
                width: "78",
                height: "158",
                stroke: if *hovered_element.read() == Some(CVE2Element::IfPc) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::IfPc) { hover_fill } else { "transparent" },
            }
            // PC label
            text {
                x: "60",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::IfPc) { hover_stroke } else { "black" },
        ...
        g {
            ...
            style: "pointer-events: all;",
            onmouseenter: move |_| {
                hovered_element.set(Some(CVE2Element::Plus4));
            },
            onmouseleave: move |_| {
                hovered_element.set(None);
            },
            ...
            rect {
                ...
                width: "38",
                height: "38",
                stroke: if *hovered_element.read() == Some(CVE2Element::Plus4) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::Plus4) { hover_fill } else { "none" },
            }
            // Plus4 label
            text {
                id: "plus4_label",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::Plus4) { hover_stroke } else { "black" },
                "+4"
            }
        ...
        g {
            ...
            rect {
                ...
                width: "158",
                height: "158",
                stroke: if *hovered_element.read() == Some(CVE2Element::InstructionMemory) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::InstructionMemory) { hover_fill } else { "none" },
            }
            ...
            text {
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::InstructionMemory) { hover_stroke } else { "black" },
                "Instruction"
            }
        ...
        g {
            ...
            rect {
                ...
                width: "78",
                height: "78",
                stroke: if *hovered_element.read() == Some(CVE2Element::IdPc) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::IdPc) { hover_fill } else { "none" },
            }
            // ID PC label
            text {
                id: "idpc_label",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::IdPc) { hover_stroke } else { "black" },
                "ID PC"
            }
        ...
        g {
            ...
            rect {
                ...
                width: "78",
                height: "78",
                stroke: if *hovered_element.read() == Some(CVE2Element::IdIr) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::IdIr) { hover_fill } else { "none" },
            }
            // ID IR label
            text {
                id: "id_ir_label",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::IdIr) { hover_stroke } else { "black" },
                "ID IR"
            }
            // IM to IF/ID arrow
            path {
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::Imm) { hover_stroke } else { "black" },
                "stroke-width": "8",
                stroke: "transparent",
            }
            ...
            line {
                ...
                x2: "779",
                y2: "286",
                stroke: if *hovered_element.read() == Some(CVE2Element::Imm) { hover_stroke } else { "black" },
                "stroke-width": "2",
            }
        ...
        g {
            ...
            line {
                ...
                x2: "760",
                y2: "427",
                stroke: if *hovered_element.read() == Some(CVE2Element::Rs1V) { hover_stroke } else { "black" },
                "stroke-width": "2",
            }
            // Invisible horizontal line with wider hit box
            line {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::Rs1V) { hover_stroke } else { "black" },
                "stroke-width": "8",
                stroke: "transparent",
            }
            text {
        ...
        g {
            ...
            line {
                ...
                x2: "790",
                y2: "446",
                stroke: if *hovered_element.read() == Some(CVE2Element::Rs2V) { hover_stroke } else { "black" },
                "stroke-width": "2",
            }
            // Invisible vertical line with wider hit box
            line {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::Rs2V) { hover_stroke } else { "black" },
                "stroke-width": "8",
                stroke: "transparent",
            }
        ...
        g {
            ...
            path {
                ...
                stroke: if *hovered_element.read() == Some(CVE2Element::OpAMux) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::OpAMux) { hover_fill } else { "none" },
            }
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::OpAMux) { hover_stroke } else { "black" },
                "PC"
            }
        ...
        g {
            ...
            path {
                ...
                stroke: if *hovered_element.read() == Some(CVE2Element::OpBMux) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::OpBMux) { hover_fill } else { "none" },
            }
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::OpBMux) { hover_stroke } else { "black" },
                "IMM"
            }
        ...
        g {
            ...
            rect {
                ...
                width: "158",
                height: "78",
                stroke: if *hovered_element.read() == Some(CVE2Element::Alu) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::Alu) { hover_fill } else { "none" },
            }
            // ALU label
            text {
                id: "alu_label",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::Alu) { hover_stroke } else { "black" },
                "ALU"
            }
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuAddr) { hover_stroke } else { "black" },
            }
            text {
                id: "addr_label",
                x: "995",
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuData) { hover_stroke } else { "black" },
            }
            // DATA label
            text {
                id: "data_label",
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuReq) { hover_stroke } else { "black" },
            }
            // REQ label
            text {
                id: "req_label",
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuWr) { hover_stroke } else { "black" },
            }
            // WR label
            text {
                id: "wr_label",
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuByteEn) { hover_stroke } else { "black" },
            }
            // BYTE_EN label
            text {
                id: "byte_en_label",
        ...
        g {
            ...
            path {
                ...
                fill: if *hovered_element.read() == Some(CVE2Element::LsuValid) { hover_stroke } else { "black" },
            }
            // VALID label
            text {
                id: "valid_label",
        ...
        g {
            ...
            rect {
                ...
                width: "282",
                height: "78",
                stroke: if *hovered_element.read() == Some(CVE2Element::LsuOut) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::LsuOut) { hover_fill } else { "none" },
            }
            // LSU label
            text {
                id: "lsu_label",
                ...
                "font-size": "20",
                "font-weight": "bold",
                fill: if *hovered_element.read() == Some(CVE2Element::LsuOut) { hover_stroke } else { "black" },
                "LSU"
            }
        ...
        g {
            ...
            path {
                ...
                stroke: if *hovered_element.read() == Some(CVE2Element::WriteMux) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::WriteMux) { hover_fill } else { "none" },
            }
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::WriteMux) { hover_stroke } else { "black" },
                "ALU"
            }
        ...
        g {
            ...
            path {
                ...
                stroke: if *hovered_element.read() == Some(CVE2Element::PcMux) { hover_stroke } else { "black" },
                "stroke-width": "2",
                fill: if *hovered_element.read() == Some(CVE2Element::PcMux) { hover_fill } else { "none" },
            }
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::PcMux) { hover_stroke } else { "black" },
                "PC+IMM"
            }
        ...
        g {
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::Rs1) { hover_stroke } else { "black" },
                "RS1"
            }
        ...
        g {
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::Rs2) { hover_stroke } else { "black" },
                "RS2"
            }
        ...
        g {
            ...
            text {
                ...
                "dominant-baseline": "middle",
                "font-size": "12",
                fill: if *hovered_element.read() == Some(CVE2Element::Rd) { hover_stroke } else { "black" },
                "RD"
            }
            // Decoder to RD arrow
            path {
